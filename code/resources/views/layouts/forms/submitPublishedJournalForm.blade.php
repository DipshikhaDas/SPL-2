<div class="card">
    <div class="card-header">
        <h4 class="card-title text-center">Submit Published Journal</h4>
    </div>
    <div class="card-body">
        <div class="basic-form">
            ...
            <form class="p-4" action="{{ route('storeJournal') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label" for="issue_no">ISBN:</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label" for="cover_photo">Upload File:</label>
                    <div class="col-sm-10">
